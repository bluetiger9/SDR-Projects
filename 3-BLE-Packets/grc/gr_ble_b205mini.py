...
class gr_ble_b205mini(gr.top_block):
    ...
    def __init__(self):
        ...
        self.digital_framer_sink_1_0 = digital.framer_sink_1(message_queue)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/packed.dat', False)
        ...
        self.connect((self.unpacked_to_packed, 0), (self.blocks_file_sink_0_0, 0))
        self.connect((self.unpacked_to_packed, 0), (self.digital_framer_sink_1_0, 0))
...
def main(top_block_cls=gr_ble_b205mini, options=None):
    tb = top_block_cls()
