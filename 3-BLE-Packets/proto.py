...
def write_pcap(fd, ble_channel, ble_access_address, ble_data):
  ...
  # Write BLE packet
  dt_str = ''.join(chr(x) for x in ble_data)
  dt_bytes_lt1 = dt_str.encode('latin1')  
  #print("PCAP packet write {} {} {} {} {} binl={} {}".format(sec, usec, ble_len, len(dt_str), "", len(dt_bytes_lt1))
  
  fd.write(dt_bytes_lt1)
  fd.flush()
